...
public class MainPKDDJ_MultipleParameters_ConstrainedCocktailParty_LoadSizeFromFile
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        //String n = "Datasets"+File.separator+"jazzReduced.txt";
        ...
        //String qp = "Experiments"+File.separator+"jazzMoreNodes"+File.separator+"Nodes";
        ...
        //String o = "Results"+File.separator+"Jazz_ConstrainedCP"; 
        ...
        */
        ...
        boolean multinodemulticore = false;
        ...
        String sizesPath = output.substring(0,output.indexOf('_'))+"_DETAILS"+mnmc+".txt";
        int[][] sizesGrCon = loadSizes(sizesPath, queryNodesNumber.length, Math.min(maxRuns, 30));
        //printMatrix(sizesGrCon);
        ...
        for (String aaa:queryNodesNumber)
        {
            ...
            HashMap<Integer, ArrayList<Integer>> queryNodes = queryFromFile(queryPath+aaa+mnmc_suffix);
            ...
            for(int j=0; j<algorithms.length; j++)
            {
                ...
                for(int i=0; i<qns; i++)
                {
                    ...
                    */ 
                    ...
                    HashSet<Integer> solution = algorithm(bbb, graph, index, q, sizesGrCon[zeze][i]);
    ...
    public static int[][] loadSizes(String path, int qnn, int qns) throws IOException
    {
        int[][] sizes = new int[qnn][qns];
        ...
        while (line != null)
        {
            if(line.startsWith("#query nodes"))
            {
                for(int j=0; j<qns; j++)
                {
                    ...
                    int s = (int)Double.parseDouble(st.nextToken());
                    sizes[i][j] = s;
                }
                i++;
            }
